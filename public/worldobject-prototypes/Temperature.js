const Temperature = function(worldObject, arg = {}) {
  ...
  this.adjustConditionBasedOnTemperature = function(timePassedMilliseconds) {
    let tempAffectsCondition = Math.abs(20 - this.temp);
    tempAffectsCondition = normalizeToValue((tempAffectsCondition - 15), 0, 100);
    this.owner.Destructible.adjustConditionBy(0 - tempAffectsCondition / timePassedMilliseconds * 100);
  };
