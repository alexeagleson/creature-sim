export default function Hud(uiObject) {
  this.owner = uiObject;
  ...
  // World.rotDisplay.drawText(2, 2, millisecondsToHHMMSS(World.Time.millisecondsSinceDayStart()), ScreenCs.SCREEN_TILE_WIDTH);
